...
export default function Home() {
  ...
  return <main>
    ...
    <section className="teaser shell" id="teaser"><Figure src="./media/teaser-hd.png" alt="HIVE-3D progressively enhances a scene from coarse to fine hierarchy levels" caption="HIVE-3D progressively enhances a coarse scene into high-resolution components and a coherent final scene." /></section>
    ...
    <section className="band results" id="results"><div className="shell"><div className="section-heading"><p className="eyebrow">Results</p><h2>Fine geometry returns without sacrificing the whole scene.</h2><p>Across synthetic and real images, the hierarchy restores small objects, thin structures, and local texture while retaining global coherence.</p></div><Figure src="./media/qualitative-hd.png" alt="Qualitative comparison with prior 3D scene generation methods" caption="Qualitative comparison with MIDI, Gen3DSR, SceneGen, TRELLIS, and HIVE-3D." />
        <div className="result-gallery"><Figure src="./media/more-results-hd.png" alt="Additional HIVE-3D generation results" caption="Additional generation results." /><Figure src="./media/ablation-study-hd.png" alt="Hierarchical generation ablation study" caption="Hierarchical generation ablation study." /></div>
